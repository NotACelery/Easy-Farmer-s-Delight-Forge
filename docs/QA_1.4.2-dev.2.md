# QA — Easy Farmer's Delight 1.4.2-dev.2 (Forge 1.20.1)

## Build and startup

- Build with Java 17 and the project Gradle configuration; candidate artifact must identify itself as `1.4.2-dev.2`.
