...
| Croptopia | Optional | Separately distributed; see the Croptopia project for its current license | Optional compatibility for 58 normal ground crops through the Rich Farmer path, registry/data integration for 26 productive fruit-tree crop leaves, and Cinnamon stripping. Croptopia crop models/textures remain supplied by the installed Croptopia mod and are not redistributed. |
| Delightful | Optional (Forge 1.20.1) | MIT | Optional registry/data integration through the Rich Farmer regrowing-crop system. Delightful models, textures, code and binaries are not redistributed. |
| Fruits Delight | Optional (Forge 1.20.1) | LGPL-2.1-only | Optional registry/data interoperability across supported Rich Farmer and Orchard lifecycles. Fruits Delight models, textures, code and binaries are not redistributed. |
| Hearth & Harvest | Optional | Separately distributed; see the project for its current license | Registry/data interoperability for persistent, regrowing and standard crop lifecycles without redistributing source assets. |
| Regions Unexplored | Optional | Separately distributed; see the project for its current license | Registry/data interoperability for supported bush and Apple Orchard behavior; source models/textures remain in the installed mod. |
| Twilight Forest | Optional | Separately distributed; see the project for its current license | Registry/data interoperability for supported regrowing crop behavior; no source assets are redistributed. |
| Deep Aether | Optional | Separately distributed; see the project for its current license | Registry/data interoperability for supported structural crop lifecycles; no source assets are redistributed. |
| Eternal Starlight | Optional | Separately distributed; see the project for its current license | Registry/data interoperability for supported structural crop lifecycles; no source assets are redistributed. |
