# QA — Easy Farmer's Delight 1.4.2 (Forge 1.20.1)

**Release status:** the final Forge release candidate was confirmed to build and function correctly. The `1.4.2` promotion contains no runtime changes; only versioning and release documentation were updated.

## Build and startup

- Build with Java 17 and the project Gradle configuration; release artifact must identify itself as `1.4.2`.
